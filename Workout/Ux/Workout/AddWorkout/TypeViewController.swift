...
class TypeViewController: UITableViewController {
    ...
    private let types: [WorkoutType]    = WorkoutType.types
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //
        let cell = tableView.dequeueReusableCell(withIdentifier: "workoutTypeCell")!
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        //  have based on the count from our WorkoutTypes enumeration / array.
        //
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        //
        //  Call our delegate to tell it what type was selected.
        //
        self.delegate?.setType(type: self.types[indexPath.row])
    ...
    //
    //  This method is used to set the selected type. 
    //
    func setSelectedType(type: WorkoutType) {
        if let foundIndex = self.types.index(where: { $0 == type } ) {
