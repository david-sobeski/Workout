...
class DifficultyViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //  accessory mark.
        //
        if self.difficulties.count > 0 {
            cell.textLabel?.text = difficulties[indexPath.row].description()
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        //
        //  Since we only have one section, we simply return the number of difficulties that we
        //  have based on the count from our Difficulties enumeration / array.
        //
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        //
        //  Call our delegate to tell it what difficulty was selected.
        //
        self.delegate?.setDifficulty(difficulty: self.difficulties[indexPath.row])
    ...
    //
    //  This method is used to set the selected difficulty. 
    //
    func setSelectedDifficulty(difficulty: Difficulty) {
        if let foundIndex = self.difficulties.index(where: { $0 == difficulty } ) {
